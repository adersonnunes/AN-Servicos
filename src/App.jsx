      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-3">
            <Link to="/">
              <img src={logoImage} alt="AN Engenharia" className="h-12 w-auto cursor-pointer" />
            </Link>
          </div>
          
          {/* Desktop Navigation */}
          <nav className="hidden md:flex space-x-6">
            <Link to="/" className="nav-item text-foreground hover:text-primary transition-colors px-3 py-2 rounded-full relative">Início</Link>
            <Link to="/sobre" className="nav-item text-foreground hover:text-primary transition-colors px-3 py-2 rounded-full relative">Sobre</Link>
            <Link to="/servicos" className="nav-item text-foreground hover:text-primary transition-colors px-3 py-2 rounded-full relative">Serviços</Link>
            <Link to="/portfolio" className="nav-item text-foreground hover:text-primary transition-colors px-3 py-2 rounded-full relative">Portfólio</Link>
            <Link to="/depoimentos" className="nav-item text-foreground hover:text-primary transition-colors px-3 py-2 rounded-full relative">Depoimentos</Link>
            <Link to="/contato" className="nav-item text-foreground hover:text-primary transition-colors px-3 py-2 rounded-full relative">Contato</Link>
          </nav>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-3">
              <Link to="/" onClick={() => setIsMenuOpen(false)} className="text-left text-foreground hover:text-primary transition-colors">Início</Link>
              <Link to="/sobre" onClick={() => setIsMenuOpen(false)} className="text-left text-foreground hover:text-primary transition-colors">Sobre</Link>
              <Link to="/servicos" onClick={() => setIsMenuOpen(false)} className="text-left text-foreground hover:text-primary transition-colors">Serviços</Link>
              <Link to="/portfolio" onClick={() => setIsMenuOpen(false)} className="text-left text-foreground hover:text-primary transition-colors">Portfólio</Link>
              <Link to="/depoimentos" onClick={() => setIsMenuOpen(false)} className="text-left text-foreground hover:text-primary transition-colors">Depoimentos</Link>
              <Link to="/contato" onClick={() => setIsMenuOpen(false)} className="text-left text-foreground hover:text-primary transition-colors">Contato</Link>
            </div>
          </motion.nav>
        )}
      </div>
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary to-primary/80 mt-16">
      <div 
...
const Services = ({ showAll = true }) => {
  const navigate = useNavigate();
  const services = showAll ? sharedData.services : sharedData.services.slice(0, 3);
...
const Testimonials = () => (
  <section id="testimonials" className="py-20 bg-muted/50">
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {sharedData.testimonials.map((testimonial, index) => (
          <motion.div
            key={index}
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
...
const Contact = ({ openWhatsAppWithConversion }) => {
          ...
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 text-sm text-muted-foreground">
                {sharedData.regions.slice(0, 8).map((region, index) => (
      ...
      <div className="grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="space-y-2 text-sm">
            <Link to="/" className="block hover:text-accent transition-colors">Início</Link>
            <Link to="/sobre" className="block hover:text-accent transition-colors">Sobre</Link>
            <Link to="/servicos" className="block hover:text-accent transition-colors">Serviços</Link>
            <Link to="/contato" className="block hover:text-accent transition-colors">Contato</Link>
          </div>
        </div>
...
const WhatsAppFloat = ({ openWhatsAppWithConversion }) => (
  <motion.div
    initial={{ scale: 0 }}
    animate={{ scale: 1 }}
  ...
  >
    <Button
      size="lg"
      className="rounded-full w-16 h-16 bg-[#25D366] hover:bg-[#20ba5a] shadow-xl transition-transform hover:scale-110 active:scale-95 border-none p-0 flex items-center justify-center"
      onClick={() => openWhatsAppWithConversion('https://wa.me/5531995702102', '_blank')}
    >
      ...
      >
        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.414 0 .018 5.393 0 12.03c0 2.123.554 4.197 1.607 6.04L0 24l6.117-1.605a11.837 11.837 0 005.925 1.586h.005c6.632 0 12.028-5.391 12.03-12.024a11.85 11.85 0 00-3.527-8.435z"/>
      </svg>
    </Button>
  </motion.div>
);
...
const HomePage = ({ openWhatsAppWithConversion, isMenuOpen, setIsMenuOpen }) => (
...
const AboutPage = ({ isMenuOpen, setIsMenuOpen }) => (
  <div className="min-h-screen">
    <Header isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />
    <div className="pt-20">
      <About />
...
const ServicesPage = ({ isMenuOpen, setIsMenuOpen }) => (
  <div className="min-h-screen">
    <Header isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />
    <div className="pt-20">
      <Services showAll={true} />
...
const PortfolioPage = ({ isMenuOpen, setIsMenuOpen }) => (
  <div className="min-h-screen">
    <Header isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />
    <div className="pt-20">
      <Portfolio />
...
const TestimonialsPage = ({ isMenuOpen, setIsMenuOpen }) => (
  <div className="min-h-screen">
    <Header isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />
    <div className="pt-20">
      <Testimonials />
...
const ContactPage = ({ openWhatsAppWithConversion, isMenuOpen, setIsMenuOpen }) => (
  <div className="min-h-screen">
    <Header isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />
    <div className="pt-20">
      <Contact openWhatsAppWithConversion={openWhatsAppWithConversion} />
...
const App = () => {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/" element={<HomePage openWhatsAppWithConversion={openWhatsAppWithConversion} isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />} />
        <Route path="/sobre" element={<AboutPage isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />} />
        <Route path="/servicos" element={<ServicesPage isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />} />
        <Route path="/portfolio" element={<PortfolioPage isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />} />
